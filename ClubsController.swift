...
final class ClubsController: UIViewController {
    ...
    private let names = ["Starry night", "Welcome party", "Donor day", "Dance concert", "Bakers concert", "Open air", "Relax day"]
    private let images = ["Image 1", "eventclub", "redcrescent", "orleanclub", "bakers", "musicclub", "artclubrelaxday"]
